...
one sig intent1__ibagc00e4o64r3hm2rjbtda04e extends Intent{}{
...
one sig intent2__q2tr8mq9s2ubddj45jqr5at2cf extends Intent{}{
//  lu.uni.serval.icc_startactivity1.OutFlowActivity: void onCreate(android.os.Bundle)
    sender=lu_uni_serval_icc_startactivity1_OutFlowActivity
	component=lu_uni_serval_icc_startactivity1_InFlowActivity
	action=NoAction
...
one sig intent3__rrdqmh3ure854iarek293n21ck extends Intent{}{
//  lu.uni.serval.icc_startactivity1.OutFlowActivity: void onCreate(android.os.Bundle)
    sender=lu_uni_serval_icc_startactivity1_OutFlowActivity
	component=lu_uni_serval_icc_startactivity1_InFlowActivity
	action=NoAction
...
one sig intent4__74bis2j6akp909244oqkcd5uvb extends Intent{}{
//  lu.uni.serval.icc_startactivity1.OutFlowActivity: void onCreate(android.os.Bundle)
    sender=lu_uni_serval_icc_startactivity1_OutFlowActivity
	component=lu_uni_serval_icc_startactivity1_InFlowActivity
	action=NoAction
