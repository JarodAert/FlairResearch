...
public class ShareCompat
{
  ...
  public static class IntentReader
  {
    ...
    public Drawable getCallingActivityIcon()
    {
      ...
      try
      {
        Drawable localDrawable = localPackageManager.getActivityIcon(mCallingActivity);
    ...
    public Drawable getCallingApplicationIcon()
    {
      ...
      try
      {
        Drawable localDrawable = localPackageManager.getApplicationIcon(mCallingPackage);
        return localDrawable;
      }
      catch (PackageManager.NameNotFoundException localNameNotFoundException)
      {
    ...
    public CharSequence getCallingApplicationLabel()
    {
      ...
      try
      {
        CharSequence localCharSequence = localPackageManager.getApplicationLabel(localPackageManager.getApplicationInfo(mCallingPackage, 0));
