...
public class ViewDragHelper
{
  ...
  private void dragTo(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt4 != 0)
    {
      ...
      mCapturedView.offsetTopAndBottom(j - m);
    }
  ...
  public void processTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 2: 
      if (mDragState == 1)
      {
        int i6 = MotionEventCompat.findPointerIndex(paramMotionEvent, mActivePointerId);
  ...
  public boolean shouldInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (mDragState == 1)
    {
      ...
      int i4 = mInitialEdgesTouched[i3];
      if ((i4 & mTrackingEdges) != 0)
      {
        mCallback.onEdgeTouched(i4 & mTrackingEdges, i3);
        continue;
        ...
        if (mDragState == 0)
        {
          int i2 = mInitialEdgesTouched[i1];
          if ((i2 & mTrackingEdges) != 0) {
            mCallback.onEdgeTouched(i2 & mTrackingEdges, i1);
          }
        }
