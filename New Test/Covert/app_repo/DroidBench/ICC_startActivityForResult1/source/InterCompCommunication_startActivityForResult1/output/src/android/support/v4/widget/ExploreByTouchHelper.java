  ...
  extends AccessibilityDelegateCompat
{
  ...
  private AccessibilityNodeInfoCompat createNodeForChild(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      int j = mTempGlobalRect[0];
      int k = mTempGlobalRect[1];
      mTempScreenRect.set(mTempParentRect);
      mTempScreenRect.offset(j, k);
  ...
  private boolean intersectVisibleToUser(Rect paramRect)
  {
    ...
    do
    {
      ...
      View localView;
      for (localViewParent = mView.getParent();; localViewParent = localView.getParent())
      {
    ...
    } while ((localViewParent == null) || (!mView.getLocalVisibleRect(mTempVisibleRect)));
