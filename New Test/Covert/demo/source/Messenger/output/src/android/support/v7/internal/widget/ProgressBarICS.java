  ...
  extends View
{
  ...
  public ProgressBarICS(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    mNoInvalidate = true;
    setMax(localTypedArray.getInt(0, mMax));
    setProgress(localTypedArray.getInt(1, mProgress));
    setSecondaryProgress(localTypedArray.getInt(2, mSecondaryProgress));
    boolean bool1 = localTypedArray.getBoolean(3, mIndeterminate);
    mOnlyIndeterminate = localTypedArray.getBoolean(4, mOnlyIndeterminate);
    ...
    mDuration = localTypedArray.getInt(7, mDuration);
    mBehavior = localTypedArray.getInt(8, mBehavior);
    mMinWidth = localTypedArray.getDimensionPixelSize(9, mMinWidth);
    mMaxWidth = localTypedArray.getDimensionPixelSize(10, mMaxWidth);
    mMinHeight = localTypedArray.getDimensionPixelSize(11, mMinHeight);
    mMaxHeight = localTypedArray.getDimensionPixelSize(12, mMaxHeight);
  ...
  private void doRefreshProgress(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          f = paramInt2 / mMax;
          localDrawable1 = mCurrentDrawable;
          if (localDrawable1 != null)
          {
  ...
  private void refreshProgress(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    for (;;)
    {
      try
      {
        ...
        {
          localRefreshProgressRunnable = mRefreshProgressRunnable;
  ...
  private void updateDrawableBounds(int paramInt1, int paramInt2)
  {
    ...
    {
      boolean bool1 = mOnlyIndeterminate;
      k = 0;
      m = 0;
      if (bool1)
      {
        boolean bool2 = mIndeterminateDrawable instanceof AnimationDrawable;
        k = 0;
        m = 0;
        if (!bool2)
        {
          int n = mIndeterminateDrawable.getIntrinsicWidth();
          int i1 = mIndeterminateDrawable.getIntrinsicHeight();
          f1 = n / i1;
    ...
    for (;;)
    {
      mIndeterminateDrawable.setBounds(k, m, i, j);
  ...
  public final void incrementProgressBy(int paramInt)
  {
    try
    {
      setProgress(paramInt + mProgress);
      return;
    }
    finally
    {
  ...
  public final void incrementSecondaryProgressBy(int paramInt)
  {
    try
    {
      setSecondaryProgress(paramInt + mSecondaryProgress);
      return;
    }
    finally
    {
  ...
  public void invalidateDrawable(Drawable paramDrawable)
  {
    if (!mInDrawing)
    {
      if (verifyDrawable(paramDrawable))
      {
        ...
        invalidate(i + left, j + top, i + right, j + bottom);
      }
    }
    else {
      return;
