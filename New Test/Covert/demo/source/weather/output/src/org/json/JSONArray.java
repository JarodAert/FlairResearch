...
public class JSONArray
{
  ...
  public Object opt(int paramInt)
  {
    ...
    return myArrayList.get(paramInt);
  }
    ...
    throws JSONException
  {
    ...
    for (;;)
    {
      ...
      for (int m = 0; m < j; m++)
      {
        ...
        localStringBuffer.append(JSONObject.valueToString(myArrayList.get(m), paramInt1, k));
      }
      localStringBuffer.append('\n');
      while (i < paramInt2)
      {
