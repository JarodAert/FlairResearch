  ...
  implements ActionProvider.SubUiVisibilityListener
{
  ...
  public void onRestoreInstanceState(Parcelable paramParcelable)
  {
    ...
    if (openSubMenuId > 0)
    {
      MenuItem localMenuItem = mMenu.findItem(openSubMenuId);
  ...
  public boolean onSubMenuSelected(SubMenuBuilder paramSubMenuBuilder)
  {
    ...
    {
      return false;
      for (localSubMenuBuilder = paramSubMenuBuilder; localSubMenuBuilder.getParentMenu() != mMenu; localSubMenuBuilder = (SubMenuBuilder)localSubMenuBuilder.getParentMenu()) {}
    } while ((findViewForItem(localSubMenuBuilder.getItem()) == null) && (mOverflowButton == null));
  ...
  public void updateMenuView(boolean paramBoolean)
  {
    ...
    if (mMenu != null)
    {
      ...
      ViewGroup localViewGroup = (ViewGroup)mOverflowButton.getParent();
      if (localViewGroup != mMenuView)
      {
        if (localViewGroup != null) {
          localViewGroup.removeView(mOverflowButton);
        }
        ActionMenuView localActionMenuView = (ActionMenuView)mMenuView;
