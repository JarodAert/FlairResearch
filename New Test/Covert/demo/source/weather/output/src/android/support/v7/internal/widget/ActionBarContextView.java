  ...
  extends AbsActionBarView
{
  ...
  public ActionBarContextView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    mTitleStyleRes = localTypedArray.getResourceId(1, 0);
    mSubtitleStyleRes = localTypedArray.getResourceId(2, 0);
    mContentHeight = localTypedArray.getLayoutDimension(0, 0);
    mSplitBackground = localTypedArray.getDrawable(4);
  ...
  public void initForMode(final ActionMode paramActionMode)
  {
    ...
    for (;;)
    {
      ...
      localMenuBuilder.addMenuPresenter(mActionMenuPresenter);
  ...
  public void setSplitActionBar(boolean paramBoolean)
  {
    ...
    if (mSplitActionBar != paramBoolean) {
      if (mActionMenuPresenter != null)
      {
        ...
        mMenuView = ((ActionMenuView)mActionMenuPresenter.getMenuView(this));
        mMenuView.setBackgroundDrawable(null);
        ViewGroup localViewGroup2 = (ViewGroup)mMenuView.getParent();
        if (localViewGroup2 != null) {
          localViewGroup2.removeView(mMenuView);
        }
        addView(mMenuView, localLayoutParams);
      }
    }
    for (;;)
    {
      ...
      mMenuView = ((ActionMenuView)mActionMenuPresenter.getMenuView(this));
      mMenuView.setBackgroundDrawable(mSplitBackground);
      ViewGroup localViewGroup1 = (ViewGroup)mMenuView.getParent();
      if (localViewGroup1 != null) {
        localViewGroup1.removeView(mMenuView);
      }
      mSplitView.addView(mMenuView, localLayoutParams);
    }
  }
