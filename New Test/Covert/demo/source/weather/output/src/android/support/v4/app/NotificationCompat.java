...
public class NotificationCompat
{
    ...
    extends NotificationCompat.NotificationCompatImplBase
  {
    ...
    {
      Notification localNotification1 = mNotification;
      localNotification1.setLatestEventInfo(mContext, mContentTitle, mContentText, mContentIntent);
      Notification localNotification2 = NotificationCompatGingerbread.add(localNotification1, mContext, mContentTitle, mContentText, mContentIntent, mFullScreenIntent);
      if (mPriority > 0) {
        flags = (0x80 | flags);
      }
    ...
    implements NotificationCompat.NotificationCompatImpl
  {
    ...
    public Notification build(NotificationCompat.Builder paramBuilder)
    {
      ...
      if (mStyle != null)
      {
        ...
        NotificationCompat.BigTextStyle localBigTextStyle = (NotificationCompat.BigTextStyle)mStyle;
      ...
      for (;;)
      {
        ...
        {
          NotificationCompat.InboxStyle localInboxStyle = (NotificationCompat.InboxStyle)mStyle;
        ...
        {
          NotificationCompat.BigPictureStyle localBigPictureStyle = (NotificationCompat.BigPictureStyle)mStyle;
