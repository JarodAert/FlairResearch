...
abstract class ActionBarActivityDelegate
{
  ...
  protected final String getUiOptionsFromMetadata()
  {
    try
    {
      ...
      if (localBundle != null)
      {
        String str = metaData.getString("android.support.UI_OPTIONS");
        localObject = str;
      }
      return localObject;
    }
  ...
  void onCreate(Bundle paramBundle)
  {
    ...
    mHasActionBar = localTypedArray.getBoolean(0, false);
    mOverlayActionBar = localTypedArray.getBoolean(1, false);
    localTypedArray.recycle();
    ...
    implements ActionBarDrawerToggle.Delegate
  {
    ...
    public Drawable getThemeUpIndicator()
    {
      ...
      arrayOfInt[0] = getHomeAsUpIndicatorAttrId();
